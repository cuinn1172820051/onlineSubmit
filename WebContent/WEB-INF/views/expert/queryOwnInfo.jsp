...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"getOwnInfoByExpert?t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
	        		...
	        		{field:'expert_id',title:'专家ID',width:50,sortable:true},
	        		{field:'username',title:'用户名',width:150},
	        		{field:'password',title:'密码',width:150},
	        		{field:'expert_name',title:'专家姓名',width:100},
