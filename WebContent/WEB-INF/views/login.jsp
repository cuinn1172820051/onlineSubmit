  ...
  <div id="loginform" class="loginBox">
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
       ...
       -->
      <div class="mt-20 skin-minimal login_row" style="text-align: center;">
		<div class="radio-box">
		...
		<div class="radio-box">
			...
			<label for="radio-2">专家</label>
		</div>
		<div class="radio-box">
			<input type="radio" id="radio-1" name="type" value="1" />
			<label for="radio-3">编辑</label>
		</div>
	</div>
      <div class="row login_row">
        <div class="formControls col-8 col-offset-3">
          <input id="submitBtn" style="margin-right:80px;" type="button" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
          <input id="registerBtn" type="button" class="btn btn-success radius size-L" value="&nbsp;注&nbsp;&nbsp;&nbsp;&nbsp;册&nbsp;">
        </div>
      </div>
    </form>
  </div>
</div>
<div class="footer">Copyright &nbsp;By Cuinn </div>
