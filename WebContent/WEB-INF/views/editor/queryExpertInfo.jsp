...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"getExpertInfoByEditor?t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
	        	...
	        	{field:'expert_id',title:'ID',width:30,sortable:true},
        		{field:'username',title:'用户名',width:150},
        		{field:'password',title:'密码',width:150},
        		{field:'expert_name',title:'作者姓名',width:100},
	    ...
	    $("#delete").click(function(){
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				//设置值
				$("#expert_id").val(selectRow.expert_id);
				$("#edit_username").textbox('setValue', selectRow.username);
				$("#edit_password").textbox('setValue', selectRow.password);
				$("#expert_name").textbox('setValue', selectRow.expert_name);
				$("#phone_number").textbox('setValue', selectRow.phone_number);
				$("#address").textbox('setValue', selectRow.address);
			}
	    });
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		...
	    		<tr>
	    			<td>姓名:</td>
	    			<td><input id="expert_name" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="expert_name" data-options="required:true, missingMessage:'请填写姓名'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>性别:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>电话号码:</td>
	    			<td><input id="phone_number" style="width: 200px; height: 30px;" class="easyui-textbox" type="phone" name="phone_number" data-options="required:true, missingMessage:'请填写电话号码'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>居住地址:</td>
	    			<td><input id="address" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="address" data-options="required:true, missingMessage:'请填写居住地址'" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
